      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <NavLink to={ConstanthPathEnum.COMPANY_LIST}>
            <Button sx={{ fontSize: '16px', fontWeight: '700' }}>
              詳細なサービス
            </Button>
          </NavLink>
          {localStorage.getItem('isAdmin') && (
            <Box>
              ...
              >
                <MenuItem>
                  <NavLink
                    to={ConstanthPathEnum.ADMIN_PRODUCT}
                    style={{ color: '#333' }}
                ...
                <MenuItem>
                  <NavLink
                    to={ConstanthPathEnum.ADMIN_CATEGORY}
                    style={{ color: '#333' }}
                    onClick={handleAdminClose}
                  >
                    カテゴリー
                ...
                <MenuItem>
                  <NavLink
                    to={ConstanthPathEnum.ADMIN_SHOP}
                    style={{ color: '#333' }}
                    onClick={handleAdminClose}
                  >
                    売り場
                ...
                <MenuItem>
                  <NavLink
                    to={ConstanthPathEnum.ADMIN_COMPANY}
                    style={{ color: '#333' }}
                    onClick={handleAdminClose}
                  >
                    運送サービス
