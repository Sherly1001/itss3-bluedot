import { Alert, Box, Button, Container, Dialog, DialogActions, DialogContent, DialogTitle, Rating, Snackbar, Typography } from "@mui/material";
                    ...
                    {companies.map((company: Company) => (
                        <Box key={company.id}
                            ...
                            <Box sx={{ display: "flex", padding: "0 10px" }}>
                                <Box sx={{ flex: 2, display: 'flex', flexDirection: 'column', alignContent: 'flex-start', gap: 3 }}>
                                    ...
                                    {localStorage.getItem('token') &&
                                        <Box>
                                            ...
                                            >
                                                ...
                                                <DialogActions>
                                                    <Button variant="contained" color="secondary" onClick={handleRate}>編集</Button>
                                                    <Button variant="contained" color="secondary" onClick={() => setSelected("")}>キャンセル</Button>
                                                </DialogActions>
                                            </Dialog>
